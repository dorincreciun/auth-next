        ...
        >
          ...
          <div className="flex shrink-0 items-center gap-2">
            <span
              className={
                device.active
                  ? "border-primary/30 bg-primary/10 text-primary rounded-full border px-2.5 py-1 text-[10px] font-semibold"
                  : "text-muted-foreground rounded-full border border-white/10 px-2.5 py-1 text-[10px] font-semibold"
              }
            >
