...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-6 -mb-6 flex flex-col-reverse gap-2.5 rounded-b-xl border-t border-white/10 bg-muted/40 px-6 py-4 sm:flex-row sm:items-center sm:justify-end sm:gap-3",
        className
      )}
      {...props}
    >
